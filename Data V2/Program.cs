...
namespace Data_V2
{
    ...
    { 
        ...
        {
            if (File.Exists(@"C:\Users\Mario David\Desktop\ejercicios\Data V2\Save.txt")) 
            {  
                Console.WriteLine("Pon la cedula del registro que deseas buscar");
                string cedula = ReadCedula();
                string[] lines = File.ReadAllLines(@"C:\Users\Mario David\Desktop\ejercicios\Data V2\Save.txt");  
        ...
        private static void AddNewRegister()
        {
            ...
            using (System.IO.StreamWriter file =
                new System.IO.StreamWriter(@"C:\Users\Mario David\Desktop\ejercicios\Data V2\Save.txt", true))
            {
